                                                            ...
                                                            <div class="product-line-grid-left col-md-2">
                                                                <span class="product-image media-middle">
                                                                    <a href="product-detail.html">
                                                                        <img class="img-fluid" src="/images/<?php echo e($item['product_img']); ?>" alt="Organic Strawberry Fruits">
                                                                    </a>
                                                                </span>
                                                            </div>
                                                            <div class="product-line-grid-body col-md-6">
                                                                <div class="product-line-info">
                                                                    <a class="label" href="product-detail.html" data-id_customization="0"><?php echo e($item['product_name']); ?></a>
                                                                </div>
                                                                <div class="product-line-info product-price">
                                                                    <span class="value"><?php echo e(number_format($item['product_price'])); ?> VNĐ</span>
                                                                </div>
                                                            </div>
                                                            <div class="product-line-grid-right text-center product-line-actions col-md-4">
                                                                <div class="row">
                                                                    <div class="col-md-5 col qty">
                                                                        ...
                                                                        <div class="quantity">
                                                                            <input type="number" style="width:70px" min="1" name="<?php echo e($item['session_id']); ?>" value="<?php echo e($item['product_count']); ?>" class="input-group form-control">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-5 col price">
                                                                        <div class="label">Total:</div>
                                                                        <div class="product-price total">
                                                                            <?php echo e(number_format((integer)$item['product_price']*(integer)$item['product_count'])); ?> VNĐ
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-2 col text-xs-right align-self-end">
                                                                        <div class="cart-line-product-actions ">
                                                                            <a class="remove-from-cart" rel="nofollow" href="<?php echo e(url('/delete-p/'.$item['session_id'])); ?>" data-link-action="delete-from-cart" data-id-product="1">
                                    ...
                                    <div class="cart-summary" style="margin-top: 78px; height:286px">
                                        <div class="cart-detailed-totals">
                                            <div class="cart-summary-products">
                                                <div class="summary-label">Có tổng <?php echo e($totalCount); ?> sản phẩm trong giỏ hàng</div>
                                            </div>
                                            <div class="cart-summary-line" id="cart-subtotal-products">
                                                <span class="label js-subtotal">
                                                    Thành tiền là
                                                </span>
                                                <span class="value"><?php echo e(number_format($totalMoney)); ?> VNĐ</span>
                                            </div>
                                        ...
                                        <ul>
                                            <li>
                                                <div class="block-reassurance-item">
                                                    <img src="<?php echo e(asset('client_template/img/product/check1.png')); ?>" alt="Security policy (edit with Customer reassurance module)">
                                                    <span>Chính sách bảo mật(CHỈNH SỬA VỚI BẢO HIỂM KHÁCH HÀNG)</span>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="block-reassurance-item">
                                                    <img src="<?php echo e(asset('client_template/img/product/check2.png')); ?>" alt="Delivery policy (edit with Customer reassurance module)">
                                                    <span>Giao hàng an toàn(CHỈNH SỬA VỚI BẢO HIỂM KHÁCH HÀNG)</span>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="block-reassurance-item">
                                                    <img src="<?php echo e(asset('client_template/img/product/check3.png')); ?>" alt="Return policy (edit with Customer reassurance module)">
...
</html><?php /**PATH D:\shopping\resources\views/client/product-cart.blade.php ENDPATH**/ ?>