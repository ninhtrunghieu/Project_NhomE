...
<body class="product-checkout checkout-cart">
                                        ...
                                        <div class="cart-summary" style="margin-top: 78px; height:286px">
                                            <div class="cart-detailed-totals">
                                                <div class="cart-summary-products">
                                                    <div class="summary-label" id="a">Có tổng <?php echo e($totalCount); ?> sản phẩm trong giỏ hàng</div>
                                                </div>
                                                <div class="cart-summary-line" id="cart-subtotal-products">
                                                    <span class="label js-subtotal">
                                                        Thành tiền là
                                                    </span>
                                                    <span class="value" id="b"><?php echo e(number_format($totalMoney)); ?> VNĐ</span>
                                                </div>
                                                ...
                                                <div class="cart-summary-line cart-total">
                                                    ...
                                                    <span class="value" id="c"><?php echo e(number_format($totalMoney)); ?> VNĐ</span>
                                                </div>
                                            </div>
                                        </div>
    ...
    <script>
        $('#myForm').on('submit', function(e) {
            ...
            $.ajax({
                url: "<?php echo e(url('/orders/save-order')); ?>",
                method: 'post',
                data: {
...
</html><?php /**PATH D:\shopping\resources\views/client/info-cart.blade.php ENDPATH**/ ?>