...
<script>
    $(document).ready(function(){
        ...
        var end = $('#end').val();
        $.ajax({
            url: "<?php echo e(url('/dashboard/get')); ?>",
            method: 'post',
            data: {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\shopping\resources\views/dashboard/dashboard.blade.php ENDPATH**/ ?>