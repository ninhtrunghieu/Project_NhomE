                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-sm btn-danger" onclick="showDeleteModal(<?php echo e($item->id); ?>)"><i class="icon ion-android-delete"></i></button>
                                </td>
                            </tr>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Nhom_E\resources\views/products/index.blade.php ENDPATH**/ ?>