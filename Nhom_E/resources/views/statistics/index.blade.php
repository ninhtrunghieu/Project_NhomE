        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    ...
                    <a style="margin-left: 20px;" href="{{ route('statistics.create') }}" class="btn btn-warning">Thêm
                        mới</a>
                </div>
                @if (session('status'))
                        ...
                        <tbody>
                            @foreach($datas as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('statistics.edit', ['id' => $item->id]) }}"
                                            class="btn btn-sm btn-success"><i class="icon ion-android-create"></i></a>
                                        <a href="{{ route('statistics.delete', ['id' => $item->id]) }}"
