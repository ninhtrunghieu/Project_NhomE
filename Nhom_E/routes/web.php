...
Route::get('/statistics/create', [StatisticalController::class, 'create'])->name('statistics.create');
Route::post('/statistics/save', [StatisticalController::class, 'save'])->name('statistics.save');
Route::get('/statistics/edit/{id}', [StatisticalController::class, 'edit'])->name('statistics.edit');
Route::post('/statistics/edit/{id}', [StatisticalController::class, 'saveedit'])->name('statistics.edit.save');
Route::get('/statistics/delete/{id}', [StatisticalController::class, 'delete'])->name('statistics.delete');
