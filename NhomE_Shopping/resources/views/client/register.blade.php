...
<!-- Mirrored from demo1.cloodo.com/html/furnitica/user-register.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 21 Feb 2021 10:19:37 GMT -->
<head>
    <!-- Basic Page Needs -->
    <meta charset="utf-8">
                        ...
                        <div id="main">
                            <div id="content" class="page-content">
                                <div class="register-form text-center">
                                    ...
                                    <form id="customer-form" action="/register-post" class="js-customer-form" method="post">
                                        @csrf
                                        <div>
                                            ...
                                            <div class="form-group">
                                                <div>
                                                    <div class="input-group js-parent-focus">
                                                        <input class="form-control js-child-focus js-visible-password" name="password" type="password" placeholder="Nhập mật khẩu">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
